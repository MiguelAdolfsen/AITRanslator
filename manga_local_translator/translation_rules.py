...
def default_target_replacements() -> tuple[TargetReplacement, ...]:
    return (
        ...
        TargetReplacement("has won everything", "got through without incident", "\u4e8b\u306a\u304d\u3092\u5f97\u305f"),
        TargetReplacement("won everything", "got through without incident", "\u4e8b\u306a\u304d\u3092\u5f97\u305f"),
        ...
        TargetReplacement("watch my organization for what it is", "be recognized as a member of my organization", "\u7d44\u7e54"),
        TargetReplacement("son of a bitch", "subordinate", "\u5b50\u5206"),
        TargetReplacement("Anja", "Anya", "\u30a2\u30fc\u30cb\u30e3"),
        TargetReplacement("Aniya", "Anya", "\u30a2\u30fc\u30cb\u30e3"),
        TargetReplacement("Anni", "Anya", "\u30a2\u30fc\u30cb\u30e3"),
        TargetReplacement("Ajit", "hideout", "\u30a2\u30b8\u30c8"),
        TargetReplacement("Ajito", "hideout", "\u30a2\u30b8\u30c8"),
        TargetReplacement("I'm going to get you", "Let's go save them", "\u52a9\u3051\u306b\u884c\u304f"),
        TargetReplacement("I'm going to get them", "Let's go save them", "\u52a9\u3051\u306b\u884c\u304f"),
        TargetReplacement("fixed her mood", "cheered up", "\u6a5f\u5acc"),
        TargetReplacement("fixing her mood", "cheering up", "\u6a5f\u5acc"),
        TargetReplacement("kill the bad guys", "take down the bad guys", "\u60aa\u3044"),
        TargetReplacement("kill the villains", "take down the villains", "\u60aa\u3044"),
        TargetReplacement("go kill", "go take down", "\u3084\u3063\u3064\u3051"),
    )
