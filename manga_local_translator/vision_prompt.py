...
def build_vision_facts_prompt(requests: list[VisionFactsRequest], *, mode: str) -> str:
    ...
    lines = [
        ...
        "Use the image only for bubble type, speaker position, visible emotion, observable action, and immediate scene context.",
        ...
        "Example output shape: {\"lines\":[{\"line_id\":\"example_001\",\"number\":1,\"source_text\":\"日本語\",\"bubble_type\":\"speech\",\"speaker_position\":\"girl on right\",\"visible_emotion\":\"surprised\",\"observable_action\":\"looking left\",\"mapping_confidence\":\"medium\",\"facts\":[\"speech bubble near girl on right\"],\"needs_review\":false,\"risk_flags\":[],\"warnings\":[]}]}",
        f"Vision mode: {mode}",
        "Lines to describe:",
